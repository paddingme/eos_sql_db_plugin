...
namespace eosio {
    ...
    void actions_table::create() {
        *m_session << "CREATE TABLE `actions` ("
                        ...
                        "`eosto` varchar(12) NOT NULL DEFAULT '',"
                        "`eosfrom` varchar(12) NOT NULL DEFAULT '',"
                        "`receiver` varchar(12) NOT NULL DEFAULT '',"
                        "`payer` varchar(12) NOT NULL DEFAULT '',"
                        "`newaccount` varchar(12) NOT NULL DEFAULT '',"
                        "PRIMARY KEY (`id`),"
